...
animationDetails.displayType = 3
  ...
  function staticDisplay() {
    ...
    var currentStaticObj = dataShapes[currentIndex]
    handleStatic(currentStaticObj)
  }

  function goodDisplay() {
    // TODO 4-b: call your handleGood function
    var currentGoodObj = dataShapes[currentIndex]
    handleGood(currentGoodObj.color, currentGoodObj.shape, currentGoodObj.repeat)
  }

  function badDisplay() {
    // TODO 5-b: call your handleBad function
    var currentBadObj = dataShapes[currentIndex]
    handleBad(currentBadObj, currentBadObj.repeat)
  }
